...
<body>
    ...
    <div id="cta">
    <h1 class = "cta-heading"><i class="fa-solid fa-seedling"></i> Flower Seeds</h1>
    </div>
    
    
    <form class="form" action="Flower_Seeds.php" method="POST">
     ...
     <button onclick="window.location.href='Flower_Seeds.php'" type="button" class="btn btn-lg btn-block btn-info"><i class="fa-solid fa-list"></i> See All</button>
     </div>
    </form>
