...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  if(mysqli_num_rows($run)>0){
      while($row = $run->fetch_assoc()){
          ...
          <td>". $row["status"] . "</td>
          <td>". '<a href="update_recycle.php?id= '.$row['id'].'" class="btn btn-lg btn-block btn btn-success"><i class="fa-solid fa-plus"></i> Accept Request</a><a href="delete_recycle.php?id= '.$row['id'].'" class="btn btn-lg btn-block btn btn-outline-danger"><i class="fa-solid fa-trash-can"></i> Delete Request</a>' .
          "</td></tr>";
          $flag = 1;
                      ...
                      $flag1 = 0;
                        ...
                        foreach($tabledata AS $row){
                         ...
                         <tr>
                            ...
                            <td><?php echo '<a href="update_recycle.php?id= '.$row['id'].'" class="btn btn-lg btn-block btn btn-success"><i class="fa-solid fa-plus"></i> Accept Request</a><a href="delete_recycle.php?id= '.$row['id'].'" class="btn btn-lg btn-block btn btn-outline-danger"><i class="fa-solid fa-trash-can"></i> Delete Request</a>'; ?></td>
                        </tr>
                        <?php
                    }
                  }
